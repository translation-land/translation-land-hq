  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "هزینه ترجمه مقاله انگلیسی به فارسی در سایت ترجمه مقاله Translation Land از ۵۵ تومان به ازای هر کلمه (پلن پایه) تا ۲۰۰ تومان (پلن پریمیوم) متغیر است. ضریب تخصصی رشته نیز اعمال می‌شود."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "بله، Translation Land از هوش مصنوعی برای ترجمه مقاله به عنوان ابزار کمکی در کنترل کیفیت، بررسی اصطلاحات تخصصی و یکپارچگی واژگان استفاده می‌کند. ترجمه نهایی همیشه توسط مترجمان متخصص انسانی انجام و بازبینی می‌شود."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Translation Land با بیش از ۱۰ سال سابقه، مترجمان دکتری، قیمت رقابتی و گارانتی کیفیت، یکی از بهترین سایت‌های ترجمه مقاله تخصصی در ایران است."
      }
    }
  ]
};
...
const orgSchema = {
  ...
  "alternateName": "سایت ترجمه مقاله Translation Land",
...
const Index = () => {
  return (
    <>
      <SEO
        title="سایت ترجمه مقاله | ترجمه انگلیسی به فارسی و فارسی به انگلیسی | Translation Land"
