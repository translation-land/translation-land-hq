...
const stats = [
  { num: "۱۰۰۰+", label: "مقاله انگلیسی ترجمه شده" },
          ...
          <div className="section-container max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <div className="prose prose-lg text-muted-foreground leading-8 space-y-4">
                ...
                <p>
                  ماموریت ما کمک به پژوهشگران و دانشجویان ایرانی برای انتشار مقالات خود در مجلات معتبر بین‌المللی است. با ارائه خدمات ترجمه تخصصی، ترجمه رسمی مدارک، ویرایش نیتیو، پارافریز و مشاوره چاپ، تمام نیازهای شما را پوشش می‌دهیم. همچنین با استفاده از هوش مصنوعی برای ترجمه مقاله، کنترل کیفیت و بررسی اصطلاحات تخصصی را ارتقا داده‌ایم.
                </p>
              </div>
            </motion.div>
          </div>
