...
const Pricing = () => {
  ...
  return (
    <>
      <SEO
        title="قیمت ترجمه مقاله | ترجمه انگلیسی به فارسی از ۵۵ تومان/کلمه | Tarjome Land"
        description="قیمت ترجمه مقاله انگلیسی به فارسی و فارسی به انگلیسی. محاسبه آنلاین قیمت ترجمه تخصصی. بدون هزینه پنهان. تخفیف دانشجویی. سایت ترجمه مقاله Tarjome Land."
